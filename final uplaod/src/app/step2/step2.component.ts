...
export class Step2Component implements OnInit {
    ...
    private mapz() {
        ...
        d3.json("./assets/us_1.json").then(function (data) {
            ...
            d3.csv("./assets/charger.csv").then(function (charger) {
                ...
                console.log("checks data", charger)

                // var projection = d3.geoAlbersUsa().scale([width]).center([-95, 39.50 ]);  
        ...
        function resize() {
            ...
            d3.selectAll("circle").attr("transform", function (d) { return "translate(" + projection([d.Longitude, d.Latitude]) + ")"; })
