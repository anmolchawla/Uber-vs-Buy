...
this.data.currentMessage2.subscribe(message => this.message = message)
this.data.currentMessage3.subscribe(message => this.message = message)
this.data.currentMessage4.subscribe(message => this.message = message)
...
$(document).ready(function(){
    ...
    year_enter (){
        ...
        window.alert("Number of years saved");
    ...
    newMessage() {
        ...
        this.data.changeMessage3(service_cost);
        this.data.changeMessage(car_name);
        this.data.changeMessage1(mpg);
        this.data.changeMessage4(years);
        this.data.changeMessage2(car_cost);
        window.alert("Do not forget to click on Save Years after entering years. Car Selection Saved - Please move to next step")
      }
