...
export class Step4Component implements OnInit {
  ...
  ngOnInit() {
    this.data.currentMessage5.subscribe(message => this.message = message)
    this.data.currentMessage6.subscribe(message => this.message = message)
    this.data.currentMessage7.subscribe(message => this.message = message)
    // this.newMessage();
    this.Mapz();
  }
  ...
  newMessage() {
    ...
    this.data.changeMessage5(commute_dist);
    this.data.changeMessage6(commute_price);
    this.data.changeMessage7(uber_name);
    window.alert("Ride Saved: Click on Step-5")
  }
          ...
          $.ajax({
            ...
            dataType:"json",
               ...
               svg.append("g").attr("transform","translate(70," + 500 + ")")
                ...
                .text("Uber Options vs Average Cost - Click on the bar to select the ride type")
